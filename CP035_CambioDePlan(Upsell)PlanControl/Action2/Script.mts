...
Sub IngresodePlan()
		...
		Dim com
		com=JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Nuevo Plan (Para DORA").JavaList("ComboBoxNative$1").GetROProperty("text")	
		While com=""
			wait 1
			com=JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Nuevo Plan (Para DORA").JavaList("ComboBoxNative$1").GetROProperty("text")
		Wend
...
Sub NegociarDistribucion()
	...
	Wend
	wait 4
	 While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución").JavaRadioButton("Nuevo").Exist=False
	 	wait 1
	 Wend
	 wait 1
...
Sub Financiamiento()
	...
	If JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 846329A").JavaCheckBox("Financiamiento Externo").Exist =True Then
...
Sub DetalleActividadOrden()
	...
	For Iterator = filas-1 To 0 step -1	    
		...
		If varselec="Cerrar Acción de Orden" or varselec="Finalizar compra en la Negociación" Then
